...
class MyHomePage extends StatelessWidget {
  ...
  final List<ItemHomepage> items = [
    ...
    ItemHomepage("All Products", Icons.shopping_cart, Colors.blue), // Biru
    ItemHomepage("My Products", Icons.list_alt, Colors.green), // Hijau
    ItemHomepage("Create Product", Icons.add, Colors.red), // Merah
  ];
...
// Kelas ItemCard (Dikeluarkan dari MenuPage)
